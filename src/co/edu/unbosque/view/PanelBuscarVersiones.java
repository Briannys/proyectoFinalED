...
public class PanelBuscarVersiones extends JPanel {
    ...
    private void inicializarComponentes() {
        labels = new JLabel[2];
        iniciarLabelTexto(0, "Buscar ejemplar por versiones:", 5, 10, 30, 700, 25, Color.white);
        iniciarLabelTexto(1, "Ingrese version para el filtro: ", 70, 90, 23, 400, 17, Color.black);
        ...
        inicializarBotones(buttons, "BUSQUEDA_VER", 0, "Buscar", 630, 80, 150, 40,
